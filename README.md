...
- `https://github.com/ChammounC/Mapty-VanillaJS.git` to clone the repository
...
- `run the project using live server` or `using the command node script.js`
<br>
